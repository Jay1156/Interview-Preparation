...
import "./NodeJsDrop.css"; // external CSS
...
const NodejsDrop = () => {
  ...
  const fetchQuestion = async () => {
    try {
      const res = await fetch("https://interview-preparation1.onrender.com/api/question?topic=Node.js");
  ...
  return (
    <div className="practice-page">
      <h2>Interview Practice with AI for Node.js</h2>
