...
const ReactDrop = () => {
  ...
  const fetchQuestion = async () => {
    try {
      const res = await fetch("https://interview-preparation1.onrender.com/api/question?topic=React");
  ...
  return (
    <div className="practice-page">
      <h2>Interview Practice with AI for React</h2>
